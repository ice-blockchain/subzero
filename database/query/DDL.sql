...
create index if not exists idx_event_tags_expired_nano                on event_tags(event_tag_key, to_timestamp_nano(cast(event_tag_value1 as bigint)) desc, id asc) where
