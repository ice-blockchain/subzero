...
var (
	...
	ErrOnBehalfAccessDenied      = errors.New("onbehalf permission denied")
	ErrAttestationUpdateRejected = errors.New("attestation list update must be linear")
)
...
type (
	...
	Config struct {
		Storage StorageCfg `yaml:"storage" mapstructure:"storage"` //nolint:tagliatelle // Nope.
	}
	StorageCfg struct {
		Credentials struct {
