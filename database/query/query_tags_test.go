...
func TestAttestationUpdateIsAllowed(t *testing.T) {
	...
	var cases = []struct {
		...
		{
			Old:     nil,
			New:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}},
			Allowed: true,
		},
		{
			Old:     nil,
			New:     model.Tags{{tagAttestationName, "pub", "", "foo"}},
			Allowed: false,
		},
		{
			Old:     nil,
			New:     model.Tags{{tagAttestationName, "pub", "", "foo:bar"}},
			Allowed: false,
		},
		{
			Old:     nil,
		...
		{
			Old:     nil,
			New:     model.Tags{{tagAttestationName, "pub", "", "foo:123:foo"}},
			Allowed: false,
		},
		{
			Old:     nil,
			New:     model.Tags{{tagAttestationName, "pub", "", "foo:123:1,2,3"}},
			Allowed: true,
		},
		{
			Old:     nil,
			New:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}, {tagAttestationName, "pub", "", "bar:123"}},
			Allowed: true,
		},
		{
			Old:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}},
			New:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}, {tagAttestationName, "pub", "", "bar:123"}},
			Allowed: true,
		},
		{
			Old:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}},
			New:     model.Tags{{tagAttestationName, "pub", "", "foo:1234"}, {tagAttestationName, "pub", "", "bar:123"}},
			Allowed: false,
		},
		{
			Old:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}},
			New:     model.Tags{{tagAttestationName, "pub", "", "foo:1234"}},
			Allowed: false,
		},
		{
			Old:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}, {tagAttestationName, "pub", "", "bar:1234"}},
			New:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}},
			Allowed: false,
		},
		{
			Old:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}},
			New:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}, {"foo", "bar"}, {tagAttestationName, "pub", "", "bar:123"}},
			Allowed: true,
		},
		{
			Old:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}, {tagAttestationName, "pub2", "", model.IceAttestationKindRevoked + ":123"}},
			New:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}, {tagAttestationName, "pub2", "", model.IceAttestationKindRevoked + ":123"}, {tagAttestationName, "pub2", "", model.IceAttestationKindActive + ":123"}},
			Allowed: false,
		},
		{
			Old:     model.Tags{{tagAttestationName, "pub", "", "foo:123"}},
