...
func TestValidateKindRepostEvent(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			validator := newEventValidator(appcontext.TestContext(t), cfg.MustGet[Config](), WithIONIdentityPublicKeys(emptyIONIdentityKeys), WithQueryFunc(func(ctx context.Context, filters ...model.Filter) query.EventIterator {
