...
func TestPostWithRichTextOnly(t *testing.T) {
	...
	validator := newEventValidator(t.Context(), &Config{}, WithIONIdentityPublicKeys(emptyIONIdentityKeys), WithQueryFunc(func(ctx context.Context, filters ...model.Filter) query.EventIterator {
