...
ALTER TABLE events ADD COLUMN IF NOT EXISTS tc_action_id TEXT
    REFERENCES events (id) ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE replaceable_events_before_update ADD COLUMN IF NOT EXISTS tc_action_id TEXT;
